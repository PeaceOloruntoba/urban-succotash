    ...
    <div className="p-4 md:p-6 space-y-4">
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm">
        ...
        <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
          <div className="flex items-center gap-2"><Clock size={16} className="text-slate-500"/> <strong>Duration:</strong> {Math.round(item.duration / 60)} minutes</div>
          <div className="flex items-center gap-2"><Tag size={16} className="text-slate-500"/> <strong>Status:</strong> <span className="capitalize px-2 py-1 text-xs rounded bg-slate-100 text-slate-800">{item.status}</span></div>
        </div>
